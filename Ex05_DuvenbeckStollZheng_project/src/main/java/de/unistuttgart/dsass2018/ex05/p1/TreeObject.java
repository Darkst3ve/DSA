...
public class TreeObject extends ATreeObject {
	...
	/**
	 * Creates a default TreeObject with anchor point with x = 0 and y = 0
	 */
	public TreeObject() {
	...
	/**
	 * Creates a TreeObject with anchor point p
	 * 
	 * @param p
	 *            Anchor point
	 */
	 ...
	 */
	public void loadObjectFromFile(BufferedReader reader) {
		try {
